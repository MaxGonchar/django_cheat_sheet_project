...
app_name = 'main'
urlpatterns = [
    # by default Django redirects registration, authentication, work with
    # passwords views to "account/..." if non-login user tries open page,
    # that requires authentication, he will be automatically redirected
    # to log-in page
